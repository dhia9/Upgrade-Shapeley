...
#######################################################
def get_stage_prefere(etud,proposes,prefs_etud):
    i=0
    list_ord_stage_etud=prefs_etud
    while i<len(list_ord_stage_etud) and list_ord_stage_etud[i] in proposes.get(etud,""):
        i+=1
    return list_ord_stage_etud[i]
...
def gale_shapley(etudiants, stages, prefs_etudiants, prefs_stages):
    ...
    while etu != None :
        ...
        stage_choisi = get_stage_prefere(etu,proposes,prefs_etudiants[etu])
